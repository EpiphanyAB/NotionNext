...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'WHH', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的干饭人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.iwhth.work', // 网站地址
  ...
  WIDGET_PET_LINK:
        ...
        'https://cdn.jsdelivr.net/npm/live2d-widget-model-epsilon2_1@1.0.5/assets/chitose.epsilon2_1.json', // 挂件模型地址 @see https://github.com/xiazeyu/live2d-widget-models
  ...
  // IMG_LAZY_LOAD_PLACEHOLDER: process.env.NEXT_PUBLIC_IMG_LAZY_LOAD_PLACEHOLDER || 'https://up.enterdesk.com/edpic/db/c9/3e/dbc93e900363616abd385c8ebb1328ec.jpg', // 懒加载占位图片地址，支持base64或url
